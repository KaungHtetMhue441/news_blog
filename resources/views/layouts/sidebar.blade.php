<div class="col-12 col-lg-3 col-xl-2 vh-100 sidebar">
    ...
    <div class="nav-menu">
        <ul>
            ...
            <x-menu-item name="Create articles" link="{{route('article.create')}}" class="feather-plus-circle" ></x-menu-item>
            <x-menu-item name="Articles lists" link="{{route('article.index')}}" class="feather-list" ></x-menu-item>
